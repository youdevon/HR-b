      ...
      <div className="flex h-16 min-w-0 items-center justify-between gap-2 px-3 sm:px-4 lg:px-6">
        ...
        <div className="flex shrink-0 items-center gap-1.5 sm:gap-3">
          ...
          <details className="group relative">
            <summary
              className={cn(
                "flex list-none cursor-pointer items-center gap-2 rounded-xl border border-neutral-200 bg-white py-1.5 pl-1.5 pr-2",
            ...
            <div className="absolute right-0 z-20 mt-2 hidden w-56 rounded-2xl border border-neutral-200 bg-white p-2 shadow-lg group-open:block">
